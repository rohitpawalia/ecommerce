    ...
    <div>
        <div className='flex items-center justify-between py-4 relative'>
             <div className='flex items-center md:space-x-10 lg:space-x-20'>
                  <div className='font-semibold text-2xl'><a href='/'>Galleria</a></div>
                  <nav className='max-md:hidden'>
                     <ul className='flex items-center lg:space-x-10 space-x-7 opacity-70 text-[15px]'>
                        <li><a href="/" className='py-3 inline-block w-full'></a>Home</li>
                        <li><a href="filter" className='py-3 inline-block w-full'></a>Filter</li>
                        {session?.user && (
            ...
            <Link href='/cart'>
                <div className='p-2 bg-gray-100 rounded-full mx-10'><CiShoppingCart size={20} /></div></Link>
        ...
        <div className={`md:hidden ${showNav ? 'pb-4 px-5' : 'h-0 invisible opacity-0'}`}>
            ...
            <input type="text" className='outline-none bg-transparent ml-2 caret-blue-500 w-full placeholder:font-light placeholder:text-gray-600 text-[15px]'
            placeholder='Search'
            autoComplete='false' />
